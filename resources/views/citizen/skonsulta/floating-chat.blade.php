<div x-data="skonsultaFloatingChat()" class="fixed bottom-6 right-6 z-50 flex flex-col items-end font-sans">
    ...
    <button @click="toggleChat()" 
        ...
        @if(($unreadMessagesCount ?? $unreadChatsCount ?? 0) > 0)
            <span class="absolute top-0 right-0 transform translate-x-1/2 -translate-y-1/2 flex h-5 min-w-[1.25rem] px-1.5 items-center justify-center rounded-full bg-red-500 text-[10px] font-bold text-white shadow-sm select-none z-20 animate-pulse">
