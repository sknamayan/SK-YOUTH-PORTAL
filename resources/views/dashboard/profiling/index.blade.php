                ...
                <div x-show="step === 1" id="step-1" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="age" x-model="age" min="6" max="39" required class="field focus:ring-4 focus:ring-blue-600/10 text-xs py-2 bg-slate-50/50 border border-slate-200 rounded-xl" placeholder="6 to 39">
                        </div>
                        <div>
