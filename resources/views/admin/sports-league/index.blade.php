        ...
        <div class="bg-white rounded-3xl shadow-xl max-w-md w-full p-6 space-y-4 border border-slate-100">
            ...
            <form :action="deleteActionUrl" method="POST" class="space-y-4">
                ...
                <div x-data="{ showPassword: false }">
                    ...
                    <div class="relative">
                        <input :type="showPassword ? 'text' : 'password'" name="password" id="admin_password" required class="w-full p-3 pr-10 bg-slate-50 border border-slate-200 rounded-xl text-xs outline-none focus:bg-white focus:border-rose-500 transition" placeholder="••••••••">
                        <button type="button" @click="showPassword = !showPassword" class="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 active:scale-95 transition focus:outline-none z-10">
