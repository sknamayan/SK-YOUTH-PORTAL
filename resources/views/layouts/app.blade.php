...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#fefefe] dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans antialiased flex flex-col min-h-screen overflow-x-hidden">
        ...
        <div id="global-page-loader" class="fixed inset-0 z-[9999] bg-[#fefefe] dark:bg-slate-950 flex flex-col pointer-events-none transition-opacity duration-300 opacity-0 md:hidden">
             <!-- Header skeleton -->
             <div class="h-16 bg-[#1e40af] dark:bg-slate-900 border-b border-blue-800 dark:border-slate-800 flex items-center px-4 md:px-8 shrink-0">
             ...
             @if(request()->routeIs('dashboard', 'dashboard.*', 'admin.*') || (auth()->check() && auth()->user()->canAccessDashboard() && request()->routeIs('profile.edit')))
                 ...
                 <div class="flex flex-1 min-h-0">
                      <!-- Sidebar skeleton -->
                      <div class="w-80 border-r border-slate-100 dark:border-slate-800 p-6 space-y-6 hidden md:block shrink-0 animate-fade-in-up">
             ...
             @elseif(request()->routeIs('profile.my-requests'))
                 ...
                 <div class="max-w-7xl mx-auto w-full p-6 md:p-8 space-y-6 flex-1 overflow-hidden">
                      ...
                      <!-- Table card skeleton -->
                      <div class="h-96 rounded-2xl md:rounded-3xl border border-slate-100 dark:border-slate-800 skeleton-shimmer"></div>
                 </div>
             @else
                 ...
                 <div class="max-w-7xl mx-auto w-full p-6 md:p-8 space-y-8 flex-1 overflow-hidden">
                      ...
                      <div class="space-y-4">
                           ...
                           <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div class="h-44 rounded-2xl border border-slate-100 dark:border-slate-800 skeleton-shimmer"></div>
                                <div class="h-44 rounded-2xl border border-slate-100 dark:border-slate-800 skeleton-shimmer"></div>
                                <div class="h-44 rounded-2xl border border-slate-100 dark:border-slate-800 skeleton-shimmer"></div>
                           </div>
                      </div>
        ...
        @php
            $hideFooter = request()->routeIs('dashboard', 'dashboard.*', 'admin.*')
                        ...
                        @auth
                            ...
                            <div class="relative">
                                ...
                                <button @click="notifOpen = !notifOpen; profileOpen = false"
                                    ...
                                    @if(($notificationsCount ?? $unreadCount ?? 0) > 0)
                                        <span class="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-rose-600 text-[9px] font-black text-white shadow-sm select-none z-10 animate-pulse">
            ...
            <div x-show="mobileMenuOpen"
                 ...
                 <div x-show="mobileMenuOpen"
                      ...
                      <div class="flex-1 overflow-y-auto px-4 py-8 space-y-3" x-data="{ servicesOpen: false, committeesOpen: false, citizenOpen: false, adminOpen: false }">
                          ...
                          <a href="{{ route('track.index') }}" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-blue-100 hover:text-white hover:bg-white/10 hover:translate-x-1 font-bold font-display uppercase tracking-wider text-[11px] transition-all duration-300">
                              <svg class="w-4 h-4 text-blue-255" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
                              <span>Track Request</span>
                          </a>

                          <!-- Our Services Dropdown -->
                          <div class="space-y-1 md:hidden">
                              <button @click="servicesOpen = !servicesOpen" type="button" class="w-full flex items-center justify-between px-4 py-3 rounded-xl text-blue-100 hover:text-white hover:bg-white/10 font-bold font-display uppercase tracking-wider text-[11px] transition-all duration-300">
                                  ...
                                  <svg class="w-3.5 h-3.5 transition-transform duration-200 text-blue-200" :class="servicesOpen ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7"></path></svg>
                              </button>
                              <div x-show="servicesOpen" x-transition class="pl-4 space-y-1 pb-2" x-cloak>
                                  <a href="{{ route('projects.committee', ['project_slug' => 'sk-namayan-youth-services', 'committee_slug' => 'education']) }}" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 hover:bg-white/10 group active:scale-[0.98]">
                                      <svg class="w-4 h-4 text-blue-300 group-hover:text-white transition shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
                                      <span class="text-xs font-semibold text-blue-100 group-hover:text-white transition leading-snug">Education & Library Services</span>
                                  </a>
                                  <a href="{{ route('projects.committee', ['project_slug' => 'sk-namayan-youth-services', 'committee_slug' => 'health']) }}" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 hover:bg-white/10 group active:scale-[0.98]">
                                      ...
                                      <span class="text-xs font-semibold text-blue-100 group-hover:text-white transition leading-snug">Health & Wellness</span>
                                  </a>
                                  <a href="{{ route('projects.committee', ['project_slug' => 'sk-namayan-youth-services', 'committee_slug' => 'governance']) }}" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 hover:bg-white/10 group active:scale-[0.98]">
                                      ...
                                      <span class="text-xs font-semibold text-blue-100 group-hover:text-white transition leading-snug">Patriotism, Governance & Active Citizenship</span>
                                  </a>
                                  <a href="{{ route('projects.committee', ['project_slug' => 'sk-namayan-youth-services', 'committee_slug' => 'active-citizenship']) }}" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 hover:bg-white/10 group active:scale-[0.98]">
                                      <svg class="w-4 h-4 text-blue-300 group-hover:text-white transition shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                                      <span class="text-xs font-semibold text-blue-100 group-hover:text-white transition leading-snug">Active Citizenship & Leadership</span>
                                  </a>
                                  <a href="{{ route('projects.committee', ['project_slug' => 'sk-namayan-youth-services', 'committee_slug' => 'social-inclusion']) }}" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 hover:bg-white/10 group active:scale-[0.98]">
                                      <svg class="w-4 h-4 text-blue-300 group-hover:text-white transition shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                                      <span class="text-xs font-semibold text-blue-100 group-hover:text-white transition leading-snug">Social Inclusion & Gender Equality</span>
                                  </a>
                                  <a href="{{ route('projects.committee', ['project_slug' => 'sk-namayan-youth-services', 'committee_slug' => 'peace-building']) }}" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 hover:bg-white/10 group active:scale-[0.98]">
                                      <svg class="w-4 h-4 text-blue-300 group-hover:text-white transition shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                                      <span class="text-xs font-semibold text-blue-100 group-hover:text-white transition leading-snug">Peace Building & Security</span>
                                  </a>
                                  <a href="{{ route('projects.committee', ['project_slug' => 'sk-namayan-youth-services', 'committee_slug' => 'environment']) }}" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 hover:bg-white/10 group active:scale-[0.98]">
                                      <svg class="w-4 h-4 text-blue-300 group-hover:text-white transition shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M6.343 6.343l-.707-.707m2.828 9.9a5 5 0 110-7.07" /></svg>
                                      <span class="text-xs font-semibold text-blue-100 group-hover:text-white transition leading-snug">Climate Change & Disaster Risk Reduction</span>
                                  </a>
                                  <a href="{{ route('projects.committee', ['project_slug' => 'sk-namayan-youth-services', 'committee_slug' => 'youth-employment']) }}" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 hover:bg-white/10 group active:scale-[0.98]">
                                      ...
                                      <span class="text-xs font-semibold text-blue-100 group-hover:text-white transition leading-snug">Youth Employment & Livelihood</span>
                                  </a>
                                  <a href="{{ route('projects.committee', ['project_slug' => 'sk-namayan-youth-services', 'committee_slug' => 'agriculture']) }}" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 hover:bg-white/10 group active:scale-[0.98]">
                                      <svg class="w-4 h-4 text-blue-300 group-hover:text-white transition shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 19l9 2m-9-2v-8m0 8l-9 2m9-2v-8m0 0a5 5 0 019 3m-9-3a5 5 0 00-9 3m9-3v-1" /></svg>
                                      <span class="text-xs font-semibold text-blue-100 group-hover:text-white transition leading-snug">Food Security & Agriculture</span>
                                  </a>
                                  <a href="{{ route('projects.committee', ['project_slug' => 'sk-namayan-youth-services', 'committee_slug' => 'global-mobility']) }}" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition-all duration-200 hover:bg-white/10 group active:scale-[0.98]">
                                      ...
                                      <span class="text-xs font-semibold text-blue-100 group-hover:text-white transition leading-snug">Global Mobility & Scholarship</span>
                                  </a>
                              </div>
                          </div>
                              ...
                              @auth
                                  ...
                                  @if(!Auth::user()->canAccessDashboard())
                                      <div class="space-y-1 border-t border-white/10 dark:border-slate-800 pt-3 mt-3">
                                          <span class="block px-4 pb-2 text-[9px] font-black text-blue-250 uppercase tracking-widest">Citizen Portal</span>
                                          ...
                                          <a href="{{ route('profile.edit') }}" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-blue-100 hover:text-white hover:bg-white/10 hover:translate-x-1 font-bold font-display uppercase tracking-wider text-[11px] transition-all duration-300">
                                              <svg class="w-4 h-4 text-blue-205" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0v-1" /></svg>
                                              <span>Account Settings</span>
                                          </a>
                                      </div>
                                  @endif
                                  ...
                                  @if(Auth::user()->canAccessDashboard())
                                      <div class="space-y-1 border-t border-white/10 dark:border-slate-800 pt-3 mt-3">
                                          <span class="block px-4 pb-2 text-[9px] font-black text-blue-250 uppercase tracking-widest">Admin Control</span>
                                          <a href="{{ route('dashboard.index') }}" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-blue-100 hover:text-white hover:bg-white/10 hover:translate-x-1 font-bold font-display uppercase tracking-wider text-[11px] transition-all duration-300">
                                              <svg class="w-4 h-4 text-blue-205" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2H6a2 2 0 01-2-2v-4zM14 16a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2h-2a2 2 0 01-2-2v-4z" /></svg>
